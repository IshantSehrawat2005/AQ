...
-- SEED COLLEGES DATA
-- ============================================================
INSERT IGNORE INTO colleges (college_name, location, course_list, cutoff_scores, entrance_cutoff, tier) VALUES
...
-- ============================================================
-- Demo student
INSERT IGNORE INTO students (name, email, password, student_marks, entrance_scores, preferences) VALUES
('Demo Student', 'demo@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 85.00, 78.00, 'CSE,AIML');
-- password is: password

INSERT IGNORE INTO admission_records (student_id, college_id, outcome, previous_scores, year) VALUES
